...
<html>
  <head>
    ...
    <title>2. Getting started &#8212; My sample book</title>
...
<span class="headerbtn__text-container">repository</span>
      ...
      <li>
        <a href="https://github.com/executablebooks/jupyter-book/issues/new?title=Issue%20on%20page%20%2Fenv/lib/python3.9/site-packages/transcrypt/docs/sphinx/installation_use.html&body=Your%20issue%20content%20here."
   class="headerbtn"
   data-toggle="tooltip"
data-placement="left"
title="Open an issue"
...
<div class="menu-dropdown menu-dropdown-download-buttons">
  ...
  <div class="menu-dropdown__content">
    <ul>
      <li>
        <a href="../../../../../../../_sources/env/lib/python3.9/site-packages/transcrypt/docs/sphinx/installation_use.rst"
   class="headerbtn"
   data-toggle="tooltip"
data-placement="left"
...
<div class="col-md-3 bd-toc show noprint">
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <ul class="nav section-nav flex-column">
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#installation-troubleshooting-checklist">
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#your-first-transcrypt-program">
   2.2. Your first Transcrypt program
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#available-command-line-switches">
   2.3. Available command line switches
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#compiling-to-javascript-6">
   2.4. Compiling to JavaScript 6
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#compiling-for-node-js">
   2.5. Compiling for node.js
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#using-sourcemaps-and-annotated-target-code">
   2.6. Using sourcemaps and annotated target code
  </a>
  <ul class="nav section-nav flex-column">
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#sourcemaps">
     2.6.1. Sourcemaps
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#annotated-target-code">
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#static-type-validation">
   2.7. Static type validation
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#getting-help-and-giving-feedback">
...
<li><p>Download the Transcrypt zip and unpack it anywhere you like</p></li>
<li><p>Add <em>../Transcrypt-&lt;version&gt;/transcrypt</em> to your system path</p></li>
</ol>
<p>To enable minification, additionally the Java Runtime Environment 6 or later has to be installed.</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>If you install Transcrypt manually, Trancrypt is started by typing <em>run_transcrypt</em> rather than <em>transcrypt</em>. This allows a pip installed Transcrypt and a manually installed Transcrypt to be used side by side selectively.</p>
</div>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>If you also use Numscrypt under Linux or OSX, use the MiniConda installer rather than <em>virtualenv</em>, as described in the Numscrypt documentation, since it will allow you to obtain the right version of NumPy.</p>
</div>
...
<ol class="arabic simple">
<li><p>Go to directory <em>../Transcrypt-&lt;version&gt;/transcrypt/development/automated_tests/transcrypt</em></p></li>
<li><p>From the command prompt run <em>transcrypt -b -c -da autotest</em>. This will compile the autotests into a number of .js files and put them into the <em>__target__</em> subdirectory. Do NOT go to that directory (there’s no need, stay where you went at point 4)</p></li>
<li><p>From the command prompt run <em>transcrypt -r -c autotest</em>. This will run the autotests with CPython creating file <em>autotest.html</em> that refers to the generated <em>autotest.js</em> file</p></li>
<li><p>Start a http server from the command prompt by typing  <em>python -m http.server</em>, or, dependent on your installation <em>python3 -m http.server</em>. In the address bar of your browser, type <em>localhost:8000/animals.html</em>. This will load the autotest, run it and compare the output with what was generated by CPython. It should report no errors</p></li>
</ol>
<p>To experiment with Transcrypt yourself:</p>
<ol class="arabic simple">
<li><p>Create a directory for your experiments</p></li>
<li><p>Make your own thing there, e.g. <em>experiment1.py</em></p></li>
<li><p>Compile with <em>transcrypt -b experiment1</em></p></li>
<li><p>Make an HTML page that will load your code in the browser. Use the HTML file generated by the autotest as an example of how to do that</p></li>
<li><p>Load and run the HTML + JS in the same way as indicated earlier.</p></li>
</ol>
<p>You may also want to try the demo’s.</p>
<section id="installation-troubleshooting-checklist">
<h3><span class="section-number">2.1.1. </span>Installation troubleshooting checklist<a class="headerlink" href="#installation-troubleshooting-checklist" title="Permalink to this headline">#</a></h3>
<ol class="arabic simple">
<li><p>Transcrypt was installed using <em>pip</em>, but <em>import transcrypt</em> fails. Transcrypt isn’t a library but a compiler. Install and run it as described in this chapter.</p></li>
<li><p>Transcrypt reports an error containing the word ‘java’. Transcrypt produces both prettyfied and minified JavaScript output. For the minification it makes use of the Google Closure Compiler, which is included in the distribution and requires Java to run. You can check proper installation of Java by typing the word <em>java</em> on the command line. This should give you a list of options: <em>Usage: java [-options] class []args…]</em> and so on. If you can’t or won’t install Java, you can run Transcrypt without minification by using the <em>-n</em> command line switch.</p></li>
<li><p>The static checker doesn’t find all errors it could. The static checks, performed by the PyFlakes package that’s part of the distribution, are of a ‘light’ variety. Style checks and false positives are avoided. The accent is on finding undefined identifiers and unused variables.</p></li>
</ol>
</section>
</section>
<section id="your-first-transcrypt-program">
<h2><span class="section-number">2.2. </span>Your first Transcrypt program<a class="headerlink" href="#your-first-transcrypt-program" title="Permalink to this headline">#</a></h2>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="linenos"> 1</span><span class="kn">from</span> <span class="nn">itertools</span> <span class="kn">import</span> <span class="n">chain</span>
<span class="linenos"> 2</span>
<span class="linenos"> 3</span><span class="k">class</span> <span class="nc">SolarSystem</span><span class="p">:</span>
<span class="linenos"> 4</span>    <span class="n">planets</span> <span class="o">=</span> <span class="p">[</span><span class="nb">list</span> <span class="p">(</span><span class="n">chain</span> <span class="p">(</span><span class="n">planet</span><span class="p">,</span> <span class="p">(</span><span class="n">index</span> <span class="o">+</span> <span class="mi">1</span><span class="p">,)))</span> <span class="k">for</span> <span class="n">index</span><span class="p">,</span> <span class="n">planet</span> <span class="ow">in</span> <span class="nb">enumerate</span> <span class="p">((</span>
<span class="linenos"> 5</span>        <span class="p">(</span><span class="s1">&#39;Mercury&#39;</span><span class="p">,</span> <span class="s1">&#39;hot&#39;</span><span class="p">,</span> <span class="mi">2240</span><span class="p">),</span>
<span class="linenos"> 6</span>        <span class="p">(</span><span class="s1">&#39;Venus&#39;</span><span class="p">,</span> <span class="s1">&#39;sulphurous&#39;</span><span class="p">,</span> <span class="mi">6052</span><span class="p">),</span>
<span class="linenos"> 7</span>        <span class="p">(</span><span class="s1">&#39;Earth&#39;</span><span class="p">,</span> <span class="s1">&#39;fertile&#39;</span><span class="p">,</span> <span class="mi">6378</span><span class="p">),</span>
<span class="linenos"> 8</span>        <span class="p">(</span><span class="s1">&#39;Mars&#39;</span><span class="p">,</span> <span class="s1">&#39;reddish&#39;</span><span class="p">,</span> <span class="mi">3397</span><span class="p">),</span>
<span class="linenos"> 9</span>        <span class="p">(</span><span class="s1">&#39;Jupiter&#39;</span><span class="p">,</span> <span class="s1">&#39;stormy&#39;</span><span class="p">,</span> <span class="mi">71492</span><span class="p">),</span>
<span class="linenos">10</span>        <span class="p">(</span><span class="s1">&#39;Saturn&#39;</span><span class="p">,</span> <span class="s1">&#39;ringed&#39;</span><span class="p">,</span> <span class="mi">60268</span><span class="p">),</span>
<span class="linenos">11</span>        <span class="p">(</span><span class="s1">&#39;Uranus&#39;</span><span class="p">,</span> <span class="s1">&#39;cold&#39;</span><span class="p">,</span> <span class="mi">25559</span><span class="p">),</span>
<span class="linenos">12</span>        <span class="p">(</span><span class="s1">&#39;Neptune&#39;</span><span class="p">,</span> <span class="s1">&#39;very cold&#39;</span><span class="p">,</span> <span class="mi">24766</span><span class="p">)</span> 
<span class="linenos">13</span>    <span class="p">))]</span>
<span class="linenos">14</span>    
<span class="linenos">15</span>    <span class="n">lines</span> <span class="o">=</span> <span class="p">(</span>
<span class="linenos">16</span>        <span class="s1">&#39;</span><span class="si">{}</span><span class="s1"> is a </span><span class="si">{}</span><span class="s1"> planet&#39;</span><span class="p">,</span>
<span class="linenos">17</span>        <span class="s1">&#39;The radius of </span><span class="si">{}</span><span class="s1"> is </span><span class="si">{}</span><span class="s1"> km&#39;</span><span class="p">,</span>
<span class="linenos">18</span>        <span class="s1">&#39;</span><span class="si">{}</span><span class="s1"> is planet nr. </span><span class="si">{}</span><span class="s1"> counting from the sun&#39;</span>
...
<span class="linenos">22</span>        <span class="bp">self</span><span class="o">.</span><span class="n">lineIndex</span> <span class="o">=</span> <span class="mi">0</span>
<span class="linenos">23</span>    
<span class="linenos">24</span>    <span class="k">def</span> <span class="nf">greet</span> <span class="p">(</span><span class="bp">self</span><span class="p">):</span>
<span class="linenos">25</span>        <span class="bp">self</span><span class="o">.</span><span class="n">planet</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">planets</span> <span class="p">[</span><span class="nb">int</span> <span class="p">(</span><span class="n">Math</span><span class="o">.</span><span class="n">random</span> <span class="p">()</span> <span class="o">*</span> <span class="nb">len</span> <span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">planets</span><span class="p">))]</span>
<span class="linenos">26</span>        <span class="n">document</span><span class="o">.</span><span class="n">getElementById</span> <span class="p">(</span><span class="s1">&#39;greet&#39;</span><span class="p">)</span> <span class="o">.</span><span class="n">innerHTML</span> <span class="o">=</span> <span class="s1">&#39;Hello </span><span class="si">{}</span><span class="s1">&#39;</span><span class="o">.</span><span class="n">format</span> <span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">planet</span> <span class="p">[</span><span class="mi">0</span><span class="p">])</span>
<span class="linenos">27</span>        <span class="bp">self</span><span class="o">.</span><span class="n">explain</span> <span class="p">()</span>
<span class="linenos">28</span>        
<span class="linenos">29</span>    <span class="k">def</span> <span class="nf">explain</span> <span class="p">(</span><span class="bp">self</span><span class="p">):</span>
<span class="linenos">30</span>        <span class="n">document</span><span class="o">.</span><span class="n">getElementById</span> <span class="p">(</span><span class="s1">&#39;explain&#39;</span><span class="p">)</span><span class="o">.</span><span class="n">innerHTML</span> <span class="o">=</span> <span class="p">(</span>
<span class="linenos">31</span>            <span class="bp">self</span><span class="o">.</span><span class="n">lines</span> <span class="p">[</span><span class="bp">self</span><span class="o">.</span><span class="n">lineIndex</span><span class="p">]</span> <span class="o">.</span><span class="n">format</span> <span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">planet</span> <span class="p">[</span><span class="mi">0</span><span class="p">],</span> <span class="bp">self</span><span class="o">.</span><span class="n">planet</span> <span class="p">[</span><span class="bp">self</span><span class="o">.</span><span class="n">lineIndex</span> <span class="o">+</span> <span class="mi">1</span><span class="p">])</span>
<span class="linenos">32</span>        <span class="p">)</span>
<span class="linenos">33</span>        <span class="bp">self</span><span class="o">.</span><span class="n">lineIndex</span> <span class="o">=</span> <span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">lineIndex</span> <span class="o">+</span> <span class="mi">1</span><span class="p">)</span> <span class="o">%</span> <span class="mi">3</span>
<span class="linenos">34</span>        
<span class="linenos">35</span><span class="n">solarSystem</span> <span class="o">=</span> <span class="n">SolarSystem</span> <span class="p">()</span>
</pre></div>
</div>
</div>
</section>
<section id="available-command-line-switches">
<span id="command-line-switches"></span><h2><span class="section-number">2.3. </span>Available command line switches<a class="headerlink" href="#available-command-line-switches" title="Permalink to this headline">#</a></h2>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">CommandArgs</span><span class="p">:</span>
    <span class="k">def</span> <span class="nf">parse</span> <span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        ...
        <span class="bp">self</span><span class="o">.</span><span class="n">argParser</span><span class="o">.</span><span class="n">add_argument</span> <span class="p">(</span><span class="s1">&#39;-od&#39;</span><span class="p">,</span> <span class="s1">&#39;--outdir&#39;</span><span class="p">,</span> <span class="n">help</span> <span class="o">=</span> <span class="s1">&#39;override output directory (default = __target__)&#39;</span><span class="p">)</span>
...
<section id="compiling-to-javascript-6">
<h2><span class="section-number">2.4. </span>Compiling to JavaScript 6<a class="headerlink" href="#compiling-to-javascript-6" title="Permalink to this headline">#</a></h2>
...
<section id="compiling-for-node-js">
<h2><span class="section-number">2.5. </span>Compiling for node.js<a class="headerlink" href="#compiling-for-node-js" title="Permalink to this headline">#</a></h2>
...
<ul class="simple">
<li><p>Install node.js from <em>https://nodejs.org</em></p></li>
<li><p>Open a node.js command prompt</p></li>
<li><p>Go to the <em>demo/nodejs_demo</em> directory</p></li>
<li><p>Compile the demo with <em>transcrypt -b -p .none nodejs_demo</em>, to generate an orphan module rather than a child of <em>window</em></p></li>
<li><p>Go to <em>demo/nodejs_demo/__target__</em> directory</p></li>
<li><p>Type <em>node nodejs_demo.js</em></p></li>
<li><p>In your browser, view the result at <em>http://localhost:8080</em></p></li>
<li><p>Repeatedly reload the page to see the text change (Google Chrome may actually reload twice)</p></li>
</ul>
</section>
<section id="using-sourcemaps-and-annotated-target-code">
<h2><span class="section-number">2.6. </span>Using sourcemaps and annotated target code<a class="headerlink" href="#using-sourcemaps-and-annotated-target-code" title="Permalink to this headline">#</a></h2>
<section id="sourcemaps">
<h3><span class="section-number">2.6.1. </span>Sourcemaps<a class="headerlink" href="#sourcemaps" title="Permalink to this headline">#</a></h3>
...
<section id="annotated-target-code">
<h3><span class="section-number">2.6.2. </span>Annotated target code<a class="headerlink" href="#annotated-target-code" title="Permalink to this headline">#</a></h3>
...
<section id="static-type-validation">
<h2><span class="section-number">2.7. </span>Static type validation<a class="headerlink" href="#static-type-validation" title="Permalink to this headline">#</a></h2>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="linenos"> 1</span><span class="c1"># from org.transcrypt.stubs.browser import __pragma__</span>
<span class="linenos"> 2</span>
<span class="linenos"> 3</span><span class="kn">from</span> <span class="nn">typing</span> <span class="kn">import</span> <span class="n">Iterator</span> <span class="c1">#, List, Dict, ClassVar</span>
<span class="linenos"> 4</span>
<span class="linenos"> 5</span><span class="kn">import</span> <span class="nn">mod1</span>
<span class="linenos"> 6</span><span class="kn">import</span> <span class="nn">mod2</span>
<span class="linenos"> 7</span>
<span class="linenos"> 8</span><span class="n">testVar</span><span class="p">:</span> <span class="nb">int</span> <span class="o">=</span> <span class="mf">3.5</span>
<span class="linenos"> 9</span>
<span class="linenos">10</span><span class="k">def</span> <span class="nf">fib</span> <span class="p">(</span><span class="n">n</span><span class="p">:</span> <span class="nb">int</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Iterator</span> <span class="p">[</span><span class="nb">int</span><span class="p">]:</span>
<span class="linenos">11</span>    <span class="n">a</span><span class="p">,</span> <span class="n">b</span> <span class="o">=</span> <span class="mi">0</span><span class="p">,</span> <span class="mi">1</span>
<span class="linenos">12</span>    <span class="k">while</span> <span class="n">a</span> <span class="o">&lt;</span> <span class="n">n</span><span class="p">:</span>
<span class="linenos">13</span>        <span class="c1"># yield a</span>
<span class="linenos">14</span>        <span class="n">a</span><span class="p">,</span> <span class="n">b</span> <span class="o">=</span> <span class="n">b</span><span class="p">,</span> <span class="n">a</span> <span class="o">+</span> <span class="n">b</span>
<span class="linenos">15</span>        
<span class="linenos">16</span>    <span class="k">return</span> <span class="mi">3</span>
<span class="linenos">17</span>        
<span class="linenos">18</span><span class="k">def</span> <span class="nf">add</span> <span class="p">(</span><span class="n">a</span><span class="p">:</span> <span class="nb">int</span><span class="p">,</span> <span class="n">b</span><span class="p">:</span> <span class="nb">int</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
<span class="linenos">19</span>    <span class="k">return</span> <span class="n">a</span> <span class="o">+</span> <span class="n">b</span>
<span class="linenos">20</span>    
<span class="linenos">21</span><span class="k">class</span> <span class="nc">A</span><span class="p">:</span>
<span class="linenos">22</span>    <span class="k">def</span> <span class="fm">__init__</span> <span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
<span class="linenos">23</span>        <span class="k">pass</span>
<span class="linenos">24</span>    
<span class="linenos">25</span>    <span class="k">def</span> <span class="nf">test</span> <span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
<span class="linenos">26</span>        <span class="k">return</span> <span class="s1">&#39;test&#39;</span>
<span class="linenos">27</span>        
<span class="linenos">28</span><span class="sd">&#39;&#39;&#39;</span>
<span class="linenos">29</span><span class="sd">__pragma__ (&#39;ifdef&#39;, &#39;__undefined__&#39;)   # Needed because Transcrypt imports are compile time</span>
<span class="linenos">30</span><span class="sd">if &#39;__undefined__&#39; in __symbols__:      # Needed because CPython doesn&#39;t understand pragmas</span>
<span class="linenos">31</span>
<span class="linenos">32</span><span class="sd">    # Variable annotations</span>
<span class="linenos">33</span>
<span class="linenos">34</span><span class="sd">    aList: List [int] = []</span>
<span class="linenos">35</span>
<span class="linenos">36</span><span class="sd">    aString: str    # Note: no initial value!</span>
<span class="linenos">37</span>
<span class="linenos">38</span><span class="sd">    class aClass:</span>
<span class="linenos">39</span><span class="sd">        aClassVar: ClassVar [Dict [str, int]] = {}</span>
<span class="linenos">40</span><span class="sd">        </span>
<span class="linenos">41</span><span class="sd">    aList = [1.1, 2.2]</span>
<span class="linenos">42</span><span class="sd">    aString = 1000</span>
<span class="linenos">43</span><span class="sd">    aClass.aClassVar = {&#39;aString&#39;, 3.14}</span>
<span class="linenos">44</span>
<span class="linenos">45</span><span class="sd">__pragma__ (&#39;endif&#39;)</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="linenos">1</span><span class="k">def</span> <span class="nf">test</span> <span class="p">(</span><span class="n">i</span><span class="p">:</span> <span class="nb">int</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">int</span><span class="p">:</span>
<span class="linenos">2</span>    <span class="n">a</span> <span class="o">=</span> <span class="mi">3</span>
<span class="linenos">3</span>    <span class="n">a</span> <span class="o">=</span> <span class="mf">4.5</span>
<span class="linenos">4</span>    <span class="k">return</span> <span class="nb">str</span> <span class="p">(</span><span class="n">i</span><span class="p">)</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="linenos">1</span><span class="k">def</span> <span class="nf">test</span> <span class="p">(</span><span class="n">i</span><span class="p">:</span> <span class="nb">str</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
<span class="linenos">2</span>    <span class="k">return</span> <span class="mi">3</span>
...
<span class="n">Performing</span> <span class="n">static</span> <span class="nb">type</span> <span class="n">validation</span> <span class="n">on</span> <span class="n">application</span><span class="p">:</span> <span class="o">//</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">modules</span><span class="o">/</span><span class="n">org</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">__runtime__</span><span class="o">.</span><span class="n">py</span>
...
<span class="n">Checking</span><span class="p">:</span> <span class="o">//</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">modules</span><span class="o">/</span><span class="n">org</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">__runtime__</span><span class="o">.</span><span class="n">py</span>
...
<span class="n">Saving</span> <span class="n">target</span> <span class="n">code</span> <span class="ow">in</span><span class="p">:</span> <span class="o">/</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">development</span><span class="o">/</span><span class="n">manual_tests</span><span class="o">/</span><span class="n">static_types</span><span class="o">/</span><span class="n">__target__</span><span class="o">/</span><span class="n">org</span><span class="o">.</span><span class="n">transcrypt</span><span class="o">.</span><span class="n">__runtime__</span><span class="o">.</span><span class="n">js</span>
<span class="n">Performing</span> <span class="n">static</span> <span class="nb">type</span> <span class="n">validation</span> <span class="n">on</span> <span class="n">application</span><span class="p">:</span> <span class="o">/</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">development</span><span class="o">/</span><span class="n">manual_tests</span><span class="o">/</span><span class="n">static_types</span><span class="o">/</span><span class="n">static_types</span><span class="o">.</span><span class="n">py</span>
<span class="n">The</span> <span class="n">following</span> <span class="n">inconsistencies</span> <span class="n">were</span> <span class="n">found</span><span class="p">:</span>
    <span class="o">/</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">development</span><span class="o">/</span><span class="n">manual_tests</span><span class="o">/</span><span class="n">static_types</span><span class="o">/</span><span class="n">static_types</span><span class="o">.</span><span class="n">py</span><span class="p">:</span><span class="mi">8</span><span class="p">:</span> <span class="n">error</span><span class="p">:</span> <span class="n">Incompatible</span> <span class="n">types</span> <span class="ow">in</span> <span class="n">assignment</span> <span class="p">(</span><span class="n">expression</span> <span class="n">has</span> <span class="nb">type</span> <span class="s2">&quot;float&quot;</span><span class="p">,</span> <span class="n">variable</span> <span class="n">has</span> <span class="nb">type</span> <span class="s2">&quot;int&quot;</span><span class="p">)</span>  <span class="p">[</span><span class="n">assignment</span><span class="p">]</span>
    <span class="o">/</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">development</span><span class="o">/</span><span class="n">manual_tests</span><span class="o">/</span><span class="n">static_types</span><span class="o">/</span><span class="n">static_types</span><span class="o">.</span><span class="n">py</span><span class="p">:</span><span class="mi">16</span><span class="p">:</span> <span class="n">error</span><span class="p">:</span> <span class="n">Incompatible</span> <span class="k">return</span> <span class="n">value</span> <span class="nb">type</span> <span class="p">(</span><span class="n">got</span> <span class="s2">&quot;int&quot;</span><span class="p">,</span> <span class="n">expected</span> <span class="s2">&quot;Iterator[int]&quot;</span><span class="p">)</span>  <span class="p">[</span><span class="k">return</span><span class="o">-</span><span class="n">value</span><span class="p">]</span>
    <span class="o">/</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">development</span><span class="o">/</span><span class="n">manual_tests</span><span class="o">/</span><span class="n">static_types</span><span class="o">/</span><span class="n">static_types</span><span class="o">.</span><span class="n">py</span><span class="p">:</span><span class="mi">19</span><span class="p">:</span> <span class="n">error</span><span class="p">:</span> <span class="n">No</span> <span class="k">return</span> <span class="n">value</span> <span class="n">expected</span>  <span class="p">[</span><span class="k">return</span><span class="o">-</span><span class="n">value</span><span class="p">]</span>
    <span class="o">/</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">development</span><span class="o">/</span><span class="n">manual_tests</span><span class="o">/</span><span class="n">static_types</span><span class="o">/</span><span class="n">static_types</span><span class="o">.</span><span class="n">py</span><span class="p">:</span><span class="mi">26</span><span class="p">:</span> <span class="n">error</span><span class="p">:</span> <span class="n">No</span> <span class="k">return</span> <span class="n">value</span> <span class="n">expected</span>  <span class="p">[</span><span class="k">return</span><span class="o">-</span><span class="n">value</span><span class="p">]</span>
    <span class="n">Found</span> <span class="mi">4</span> <span class="n">errors</span> <span class="ow">in</span> <span class="mi">1</span> <span class="n">file</span> <span class="p">(</span><span class="n">checked</span> <span class="mi">1</span> <span class="n">source</span> <span class="n">file</span><span class="p">)</span>
    

<span class="n">Checking</span><span class="p">:</span> <span class="o">/</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">development</span><span class="o">/</span><span class="n">manual_tests</span><span class="o">/</span><span class="n">static_types</span><span class="o">/</span><span class="n">static_types</span><span class="o">.</span><span class="n">py</span>
    <span class="n">Internal</span> <span class="n">error</span> <span class="ow">in</span> <span class="n">lightweight</span> <span class="n">consistency</span> <span class="n">checker</span><span class="p">,</span> <span class="n">remainder</span> <span class="n">of</span> <span class="n">module</span> <span class="n">skipped</span>
<span class="n">Performing</span> <span class="n">static</span> <span class="nb">type</span> <span class="n">validation</span> <span class="n">on</span> <span class="n">application</span><span class="p">:</span> <span class="o">/</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">development</span><span class="o">/</span><span class="n">manual_tests</span><span class="o">/</span><span class="n">static_types</span><span class="o">/</span><span class="n">mod2</span><span class="o">/</span><span class="fm">__init__</span><span class="o">.</span><span class="n">py</span>
<span class="n">The</span> <span class="n">following</span> <span class="n">inconsistencies</span> <span class="n">were</span> <span class="n">found</span><span class="p">:</span>
    <span class="o">/</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">development</span><span class="o">/</span><span class="n">manual_tests</span><span class="o">/</span><span class="n">static_types</span><span class="o">/</span><span class="n">mod2</span><span class="o">/</span><span class="fm">__init__</span><span class="o">.</span><span class="n">py</span><span class="p">:</span><span class="mi">2</span><span class="p">:</span> <span class="n">error</span><span class="p">:</span> <span class="n">Incompatible</span> <span class="k">return</span> <span class="n">value</span> <span class="nb">type</span> <span class="p">(</span><span class="n">got</span> <span class="s2">&quot;int&quot;</span><span class="p">,</span> <span class="n">expected</span> <span class="s2">&quot;str&quot;</span><span class="p">)</span>  <span class="p">[</span><span class="k">return</span><span class="o">-</span><span class="n">value</span><span class="p">]</span>
...
<span class="n">Checking</span><span class="p">:</span> <span class="o">/</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">development</span><span class="o">/</span><span class="n">manual_tests</span><span class="o">/</span><span class="n">static_types</span><span class="o">/</span><span class="n">mod2</span><span class="o">/</span><span class="fm">__init__</span><span class="o">.</span><span class="n">py</span>
    <span class="n">Internal</span> <span class="n">error</span> <span class="ow">in</span> <span class="n">lightweight</span> <span class="n">consistency</span> <span class="n">checker</span><span class="p">,</span> <span class="n">remainder</span> <span class="n">of</span> <span class="n">module</span> <span class="n">skipped</span>
<span class="n">Saving</span> <span class="n">target</span> <span class="n">code</span> <span class="ow">in</span><span class="p">:</span> <span class="o">/</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">development</span><span class="o">/</span><span class="n">manual_tests</span><span class="o">/</span><span class="n">static_types</span><span class="o">/</span><span class="n">__target__</span><span class="o">/</span><span class="n">mod2</span><span class="o">.</span><span class="n">js</span>
<span class="n">Performing</span> <span class="n">static</span> <span class="nb">type</span> <span class="n">validation</span> <span class="n">on</span> <span class="n">application</span><span class="p">:</span> <span class="o">/</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">development</span><span class="o">/</span><span class="n">manual_tests</span><span class="o">/</span><span class="n">static_types</span><span class="o">/</span><span class="n">mod1</span><span class="o">.</span><span class="n">py</span>
<span class="n">The</span> <span class="n">following</span> <span class="n">inconsistencies</span> <span class="n">were</span> <span class="n">found</span><span class="p">:</span>
    <span class="o">/</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">development</span><span class="o">/</span><span class="n">manual_tests</span><span class="o">/</span><span class="n">static_types</span><span class="o">/</span><span class="n">mod1</span><span class="o">.</span><span class="n">py</span><span class="p">:</span><span class="mi">3</span><span class="p">:</span> <span class="n">error</span><span class="p">:</span> <span class="n">Incompatible</span> <span class="n">types</span> <span class="ow">in</span> <span class="n">assignment</span> <span class="p">(</span><span class="n">expression</span> <span class="n">has</span> <span class="nb">type</span> <span class="s2">&quot;float&quot;</span><span class="p">,</span> <span class="n">variable</span> <span class="n">has</span> <span class="nb">type</span> <span class="s2">&quot;int&quot;</span><span class="p">)</span>  <span class="p">[</span><span class="n">assignment</span><span class="p">]</span>
    <span class="o">/</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">development</span><span class="o">/</span><span class="n">manual_tests</span><span class="o">/</span><span class="n">static_types</span><span class="o">/</span><span class="n">mod1</span><span class="o">.</span><span class="n">py</span><span class="p">:</span><span class="mi">4</span><span class="p">:</span> <span class="n">error</span><span class="p">:</span> <span class="n">Incompatible</span> <span class="k">return</span> <span class="n">value</span> <span class="nb">type</span> <span class="p">(</span><span class="n">got</span> <span class="s2">&quot;str&quot;</span><span class="p">,</span> <span class="n">expected</span> <span class="s2">&quot;int&quot;</span><span class="p">)</span>  <span class="p">[</span><span class="k">return</span><span class="o">-</span><span class="n">value</span><span class="p">]</span>
    <span class="n">Found</span> <span class="mi">2</span> <span class="n">errors</span> <span class="ow">in</span> <span class="mi">1</span> <span class="n">file</span> <span class="p">(</span><span class="n">checked</span> <span class="mi">1</span> <span class="n">source</span> <span class="n">file</span><span class="p">)</span>
    

<span class="n">Checking</span><span class="p">:</span> <span class="o">/</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">development</span><span class="o">/</span><span class="n">manual_tests</span><span class="o">/</span><span class="n">static_types</span><span class="o">/</span><span class="n">mod1</span><span class="o">.</span><span class="n">py</span>
    <span class="n">Internal</span> <span class="n">error</span> <span class="ow">in</span> <span class="n">lightweight</span> <span class="n">consistency</span> <span class="n">checker</span><span class="p">,</span> <span class="n">remainder</span> <span class="n">of</span> <span class="n">module</span> <span class="n">skipped</span>
<span class="n">Saving</span> <span class="n">target</span> <span class="n">code</span> <span class="ow">in</span><span class="p">:</span> <span class="o">/</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">development</span><span class="o">/</span><span class="n">manual_tests</span><span class="o">/</span><span class="n">static_types</span><span class="o">/</span><span class="n">__target__</span><span class="o">/</span><span class="n">mod1</span><span class="o">.</span><span class="n">js</span>
...
<span class="n">Checking</span><span class="p">:</span> <span class="o">//</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">modules</span><span class="o">/</span><span class="n">typing</span><span class="o">/</span><span class="fm">__init__</span><span class="o">.</span><span class="n">py</span>
    <span class="n">Internal</span> <span class="n">error</span> <span class="ow">in</span> <span class="n">lightweight</span> <span class="n">consistency</span> <span class="n">checker</span><span class="p">,</span> <span class="n">remainder</span> <span class="n">of</span> <span class="n">module</span> <span class="n">skipped</span>
<span class="n">Saving</span> <span class="n">target</span> <span class="n">code</span> <span class="ow">in</span><span class="p">:</span> <span class="o">/</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">development</span><span class="o">/</span><span class="n">manual_tests</span><span class="o">/</span><span class="n">static_types</span><span class="o">/</span><span class="n">__target__</span><span class="o">/</span><span class="n">typing</span><span class="o">.</span><span class="n">js</span>
<span class="n">Saving</span> <span class="n">target</span> <span class="n">code</span> <span class="ow">in</span><span class="p">:</span> <span class="o">/</span><span class="n">home</span><span class="o">/</span><span class="n">data</span><span class="o">/</span><span class="n">Python</span><span class="o">/</span><span class="n">Transcrypt</span><span class="o">/</span><span class="n">repo_transcrypt</span><span class="o">/</span><span class="n">transcrypt</span><span class="o">/</span><span class="n">development</span><span class="o">/</span><span class="n">manual_tests</span><span class="o">/</span><span class="n">static_types</span><span class="o">/</span><span class="n">__target__</span><span class="o">/</span><span class="n">static_types</span><span class="o">.</span><span class="n">js</span>
...
<section id="getting-help-and-giving-feedback">
<h2><span class="section-number">2.8. </span>Getting help and giving feedback<a class="headerlink" href="#getting-help-and-giving-feedback" title="Permalink to this headline">#</a></h2>
