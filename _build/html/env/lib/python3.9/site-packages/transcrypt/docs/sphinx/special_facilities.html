...
<html>
  <head>
    ...
    <title>3. Special facilities &#8212; My sample book</title>
...
<span class="headerbtn__text-container">repository</span>
      ...
      <li>
        <a href="https://github.com/executablebooks/jupyter-book/issues/new?title=Issue%20on%20page%20%2Fenv/lib/python3.9/site-packages/transcrypt/docs/sphinx/special_facilities.html&body=Your%20issue%20content%20here."
   class="headerbtn"
   data-toggle="tooltip"
data-placement="left"
title="Open an issue"
...
<div class="menu-dropdown menu-dropdown-download-buttons">
  ...
  <div class="menu-dropdown__content">
    <ul>
      <li>
        <a href="../../../../../../../_sources/env/lib/python3.9/site-packages/transcrypt/docs/sphinx/special_facilities.rst"
   class="headerbtn"
   data-toggle="tooltip"
data-placement="left"
...
<div class="col-md-3 bd-toc show noprint">
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#transcrypt-s-module-mechanism">
   3.1. Transcrypt’s module mechanism
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#using-browser-stubs-to-test-non-gui-code-that-uses-console-log-and-window-alert">
   3.2. Using browser stubs to test non-GUI code that uses console.log and window.alert
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#creating-javascript-objects-with-new-constructor-call">
   3.3. Creating JavaScript objects with __new__ (&lt;constructor call&gt;)
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#the-pragma-mechanism">
   3.4. The __pragma__ mechanism
  </a>
  <ul class="nav section-nav flex-column">
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#the-function-like-variety">
     3.4.1. The function-like variety
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#the-comment-like-variety">
     3.4.2. The comment-like variety
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#the-single-line-activation-variety">
     3.4.3. The single-line activation variety
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#the-single-line-deactivation-variety">
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#pragma-alias">
   3.5. Identifier aliasing: __pragma__ (‘alias’, …) and __pragma__ (‘noalias’, …)
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#generating-doc-attributes-from-docstrings-pragma-docat-and-pragma-nodocat">
   3.6. Generating __doc__ attributes from docstrings: __pragma__ (‘docat’) and __pragma__ (‘nodocat’)
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#skipping-transcrypt-code-fragments-when-running-with-cpython-pragma-ecom-and-pragma-noecom">
   3.7. Skipping Transcrypt code fragments when running with CPython: __pragma__ (‘ecom’) and __pragma__ (‘noecom’)
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#surpassing-the-speed-of-native-javascript-pragma-fcall-and-pragma-nofcall">
   3.8. Surpassing the speed of native JavaScript: __pragma__ (‘fcall’) and __pragma (‘nofcall’)
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#enabling-pythons-send-syntax-pragma-gsend-and-pragma-nogsend">
   3.9. Enabling Pythons
   <em>
    send
   </em>
   syntax: __pragma__ (‘gsend’) and __pragma (‘nogsend’)
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#automatic-conversion-to-iterable-pragma-iconv-and-pragma-noiconv">
   3.10. Automatic conversion to iterable: __pragma__ (‘iconv’) and __pragma__ (‘noiconv’)
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#conditional-compilation-pragma-ifdef-symbol-pragma-ifndef-symbol-pragma-else-and-pragma-endif">
   3.11. Conditional compilation: __pragma__ (‘ifdef’, &lt;symbol&gt;), __pragma__ (‘ifndef’, &lt;symbol&gt;), __pragma__ (‘else’) and __pragma__ (‘endif’)
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#inserting-literal-javascript-pragma-js-and-include">
   3.12. Inserting literal JavaScript: __pragma__ (‘js’, …) and __include__ (…)
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#pragma-jskeys-and-pragma-nojskeys">
   3.13. __pragma__ (‘jskeys’) and __pragma__ (‘nojskeys’)
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#keeping-your-code-lean-pragma-jsmod-and-pragma-nojsmod">
   3.14. Keeping your code lean: __pragma__ (‘jsmod’) and __pragma__ (‘nojsmod’)
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#pragma-keycheck-and-pragma-nokeycheck">
   3.15. __pragma__ (‘keycheck’) and __pragma__ (‘nokeycheck’)
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#keeping-your-code-lean-pragma-kwargs-and-pragma-nokwargs">
   3.16. Keeping your code lean: __pragma__ (‘kwargs’) and __pragma__ (‘nokwargs’)
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#preventing-target-annotation-pragma-noanno">
   3.17. Preventing target annotation: __pragma__ (‘noanno’)
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#operator-overloading-pragma-opov-and-pragma-noopov">
   3.18. Operator overloading: __pragma__ (‘opov’) and __pragma__ (‘noopov’)
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#skipping-fragments-while-generating-code-pragma-skip-and-pragma-noskip">
   3.19. Skipping fragments while generating code: __pragma__ (‘skip’) and __pragma__ (‘noskip’)
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#automatic-conversion-to-truth-value-pragma-tconv-and-pragma-notconv">
   3.20. Automatic conversion to truth value: __pragma__ (‘tconv’) and __pragma__ (‘notconv’)
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#adding-directories-to-the-module-search-path-pragma-xpath-directory-list">
   3.21. Adding directories to the module search path: __pragma__ (‘xpath’, &lt;directory list&gt;)
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#using-an-external-transpiler-pragma-xtrans-translator-cwd-workingdirectory">
   3.22. Using an external transpiler: __pragma__ (‘xtrans’, &lt;translator&gt;, …, cwd = &lt;workingdirectory&gt;)
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#create-bare-javascript-objects-and-iterate-over-their-attributes-from-python-pragma-jsiter-and-pragma-nojsiter">
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <section id="special-facilities">
<h1><span class="section-number">3. </span>Special facilities<a class="headerlink" href="#special-facilities" title="Permalink to this headline">#</a></h1>
<section id="transcrypt-s-module-mechanism">
<span id="module-mechanism"></span><h2><span class="section-number">3.1. </span>Transcrypt’s module mechanism<a class="headerlink" href="#transcrypt-s-module-mechanism" title="Permalink to this headline">#</a></h2>
...
<ul class="simple">
<li><p><em>com.github.&lt;my name&gt;.&lt;my module name&gt;</em></p></li>
<li><p><em>org.python.pypi.&lt;my module name&gt;</em></p></li>
<li><p><em>com.&lt;my company name&gt;.&lt;my module name&gt;</em></p></li>
</ul>
...
<blockquote>
<div><ul class="simple">
<li><p><em>&lt;directory of your main module&gt;/all/the/kings/men.py</em></p></li>
<li><p><em>&lt;directory of your main module&gt;/all/the/kings/men.js</em></p></li>
<li><p><em>&lt;directory of your main module&gt;/all/the/kings/men/__init__.py</em></p></li>
<li><p><em>&lt;directory of your main module&gt;/all/the/kings/men/__init__.js</em></p></li>
</ul>
<ul class="simple">
<li><p><em>transcrypt/Transcrypt/modules/all/the/kings/men.py</em></p></li>
<li><p><em>transcrypt/Transcrypt/modules/all/the/kings/men.js</em></p></li>
<li><p><em>transcrypt/Transcrypt/modules/all/the/kings/men/__init__py</em></p></li>
<li><p><em>transcrypt/Transcrypt/modules/all/the/kings/men/__init__js</em></p></li>
</ul>
<ul class="simple">
<li><p><em>&lt;CPython packages directory 1&gt;/all/the/kings/men.py</em></p></li>
<li><p><em>&lt;CPython packages directory 1&gt;/all/the/kings/men.js</em></p></li>
<li><p><em>&lt;CPython packages directory 1&gt;/all/the/kings/men/__init__.py</em></p></li>
<li><p><em>&lt;CPython packages directory 1&gt;/all/the/kings/men/__init__.js</em></p></li>
</ul>
<ul class="simple">
<li><p><em>&lt;CPython packages directory 2&gt;/all/the/kings/men.py</em></p></li>
<li><p><em>&lt;CPython packages directory 2&gt;/all/the/kings/men.js</em></p></li>
<li><p><em>&lt;CPython packages directory 2&gt;/all/the/kings/men/__init__.py</em></p></li>
<li><p><em>&lt;CPython packages directory 2&gt;/all/the/kings/men/__init__.js</em></p></li>
</ul>
<ul class="simple">
<li><p><em>More CPython packages directories</em></p></li>
</ul>
</div></blockquote>
...
<section id="using-browser-stubs-to-test-non-gui-code-that-uses-console-log-and-window-alert">
<h2><span class="section-number">3.2. </span>Using browser stubs to test non-GUI code that uses console.log and window.alert<a class="headerlink" href="#using-browser-stubs-to-test-non-gui-code-that-uses-console-log-and-window-alert" title="Permalink to this headline">#</a></h2>
...
<section id="creating-javascript-objects-with-new-constructor-call">
<h2><span class="section-number">3.3. </span>Creating JavaScript objects with __new__ (&lt;constructor call&gt;)<a class="headerlink" href="#creating-javascript-objects-with-new-constructor-call" title="Permalink to this headline">#</a></h2>
...
<section id="the-pragma-mechanism">
<h2><span class="section-number">3.4. </span>The __pragma__ mechanism<a class="headerlink" href="#the-pragma-mechanism" title="Permalink to this headline">#</a></h2>
...
<section id="the-function-like-variety">
<h3><span class="section-number">3.4.1. </span>The function-like variety<a class="headerlink" href="#the-function-like-variety" title="Permalink to this headline">#</a></h3>
...
<section id="the-comment-like-variety">
<h3><span class="section-number">3.4.2. </span>The comment-like variety<a class="headerlink" href="#the-comment-like-variety" title="Permalink to this headline">#</a></h3>
...
<section id="the-single-line-activation-variety">
<h3><span class="section-number">3.4.3. </span>The single-line activation variety<a class="headerlink" href="#the-single-line-activation-variety" title="Permalink to this headline">#</a></h3>
...
<section id="the-single-line-deactivation-variety">
<h3><span class="section-number">3.4.4. </span>The single-line deactivation variety<a class="headerlink" href="#the-single-line-deactivation-variety" title="Permalink to this headline">#</a></h3>
<p><em>scalar2 = scalar0 + scalar1 # __:noopov</em></p>
<p>will be compiled identically to:</p>
<p><em>__pragma__ (‘noopov’); scalar2 = scalar0 + scalar1; __pragma__ (‘opov’)</em></p>
</section>
</section>
<section id="pragma-alias">
<span id="identifier-aliasing-pragma-alias-and-pragma-noalias"></span><h2><span class="section-number">3.5. </span>Identifier aliasing: __pragma__ (‘alias’, …) and __pragma__ (‘noalias’, …)<a class="headerlink" href="#pragma-alias" title="Permalink to this headline">#</a></h2>
...
<tbody>
<tr class="row-odd"><td colspan="2"><p>Used at the start of the module: <em>__pragma__ (‘alias’, ‘S’, ‘$’)</em></p></td>
</tr>
<tr class="row-even"><td><p>Original in Python:</p></td>
<td><p>Alias in JavaScript:</p></td>
</tr>
<tr class="row-odd"><td><p><em>S (‘body’)</em></p></td>
<td><p><em>$ (‘body’)</em></p></td>
</tr>
<tr class="row-even"><td><p><em>S__body</em></p></td>
<td><p><em>$body</em></p></td>
</tr>
<tr class="row-odd"><td><p><em>S__She__S__Sells__S__Sea__S__Shells__S</em></p></td>
<td><p><em>$She$Sells$Sea$Shells$</em></p></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr class="row-odd"><td colspan="2"><p>Used at the start of the module <em>__pragma__ (‘alias’, ‘jq’, ‘$’)</em></p></td>
</tr>
<tr class="row-even"><td><p><em>jq__body = jq (body)</em></p></td>
<td><p><em>$body = $ (‘body’)</em></p></td>
</tr>
</tbody>
</table>
...
<section id="generating-doc-attributes-from-docstrings-pragma-docat-and-pragma-nodocat">
<h2><span class="section-number">3.6. </span>Generating __doc__ attributes from docstrings: __pragma__ (‘docat’) and __pragma__ (‘nodocat’)<a class="headerlink" href="#generating-doc-attributes-from-docstrings-pragma-docat-and-pragma-nodocat" title="Permalink to this headline">#</a></h2>
...
<section id="skipping-transcrypt-code-fragments-when-running-with-cpython-pragma-ecom-and-pragma-noecom">
<h2><span class="section-number">3.7. </span>Skipping Transcrypt code fragments when running with CPython: __pragma__ (‘ecom’) and __pragma__ (‘noecom’)<a class="headerlink" href="#skipping-transcrypt-code-fragments-when-running-with-cpython-pragma-ecom-and-pragma-noecom" title="Permalink to this headline">#</a></h2>
...
<section id="surpassing-the-speed-of-native-javascript-pragma-fcall-and-pragma-nofcall">
<h2><span class="section-number">3.8. </span>Surpassing the speed of native JavaScript: __pragma__ (‘fcall’) and __pragma (‘nofcall’)<a class="headerlink" href="#surpassing-the-speed-of-native-javascript-pragma-fcall-and-pragma-nofcall" title="Permalink to this headline">#</a></h2>
...
<section id="enabling-pythons-send-syntax-pragma-gsend-and-pragma-nogsend">
<h2><span class="section-number">3.9. </span>Enabling Pythons <em>send</em> syntax: __pragma__ (‘gsend’) and __pragma (‘nogsend’)<a class="headerlink" href="#enabling-pythons-send-syntax-pragma-gsend-and-pragma-nogsend" title="Permalink to this headline">#</a></h2>
...
<section id="automatic-conversion-to-iterable-pragma-iconv-and-pragma-noiconv">
<h2><span class="section-number">3.10. </span>Automatic conversion to iterable: __pragma__ (‘iconv’) and __pragma__ (‘noiconv’)<a class="headerlink" href="#automatic-conversion-to-iterable-pragma-iconv-and-pragma-noiconv" title="Permalink to this headline">#</a></h2>
...
<section id="conditional-compilation-pragma-ifdef-symbol-pragma-ifndef-symbol-pragma-else-and-pragma-endif">
<span id="pragma-ifdef"></span><h2><span class="section-number">3.11. </span>Conditional compilation: __pragma__ (‘ifdef’, &lt;symbol&gt;), __pragma__ (‘ifndef’, &lt;symbol&gt;), __pragma__ (‘else’) and __pragma__ (‘endif’)<a class="headerlink" href="#conditional-compilation-pragma-ifdef-symbol-pragma-ifndef-symbol-pragma-else-and-pragma-endif" title="Permalink to this headline">#</a></h2>
...
<section id="inserting-literal-javascript-pragma-js-and-include">
<span id="pragma-js"></span><h2><span class="section-number">3.12. </span>Inserting literal JavaScript: __pragma__ (‘js’, …) and __include__ (…)<a class="headerlink" href="#inserting-literal-javascript-pragma-js-and-include" title="Permalink to this headline">#</a></h2>
...
<section id="pragma-jskeys-and-pragma-nojskeys">
<h2><span class="section-number">3.13. </span>__pragma__ (‘jskeys’) and __pragma__ (‘nojskeys’)<a class="headerlink" href="#pragma-jskeys-and-pragma-nojskeys" title="Permalink to this headline">#</a></h2>
...
<section id="keeping-your-code-lean-pragma-jsmod-and-pragma-nojsmod">
<h2><span class="section-number">3.14. </span>Keeping your code lean: __pragma__ (‘jsmod’) and __pragma__ (‘nojsmod’)<a class="headerlink" href="#keeping-your-code-lean-pragma-jsmod-and-pragma-nojsmod" title="Permalink to this headline">#</a></h2>
...
<section id="pragma-keycheck-and-pragma-nokeycheck">
<h2><span class="section-number">3.15. </span>__pragma__ (‘keycheck’) and __pragma__ (‘nokeycheck’)<a class="headerlink" href="#pragma-keycheck-and-pragma-nokeycheck" title="Permalink to this headline">#</a></h2>
...
<section id="keeping-your-code-lean-pragma-kwargs-and-pragma-nokwargs">
<h2><span class="section-number">3.16. </span>Keeping your code lean: __pragma__ (‘kwargs’) and __pragma__ (‘nokwargs’)<a class="headerlink" href="#keeping-your-code-lean-pragma-kwargs-and-pragma-nokwargs" title="Permalink to this headline">#</a></h2>
...
<section id="preventing-target-annotation-pragma-noanno">
<h2><span class="section-number">3.17. </span>Preventing target annotation: __pragma__ (‘noanno’)<a class="headerlink" href="#preventing-target-annotation-pragma-noanno" title="Permalink to this headline">#</a></h2>
...
<section id="operator-overloading-pragma-opov-and-pragma-noopov">
<h2><span class="section-number">3.18. </span>Operator overloading: __pragma__ (‘opov’) and __pragma__ (‘noopov’)<a class="headerlink" href="#operator-overloading-pragma-opov-and-pragma-noopov" title="Permalink to this headline">#</a></h2>
...
<section id="skipping-fragments-while-generating-code-pragma-skip-and-pragma-noskip">
<span id="skipping-fragments"></span><h2><span class="section-number">3.19. </span>Skipping fragments while generating code: __pragma__ (‘skip’) and __pragma__ (‘noskip’)<a class="headerlink" href="#skipping-fragments-while-generating-code-pragma-skip-and-pragma-noskip" title="Permalink to this headline">#</a></h2>
...
<section id="automatic-conversion-to-truth-value-pragma-tconv-and-pragma-notconv">
<h2><span class="section-number">3.20. </span>Automatic conversion to truth value: __pragma__ (‘tconv’) and __pragma__ (‘notconv’)<a class="headerlink" href="#automatic-conversion-to-truth-value-pragma-tconv-and-pragma-notconv" title="Permalink to this headline">#</a></h2>
...
<section id="adding-directories-to-the-module-search-path-pragma-xpath-directory-list">
<h2><span class="section-number">3.21. </span>Adding directories to the module search path: __pragma__ (‘xpath’, &lt;directory list&gt;)<a class="headerlink" href="#adding-directories-to-the-module-search-path-pragma-xpath-directory-list" title="Permalink to this headline">#</a></h2>
...
<section id="using-an-external-transpiler-pragma-xtrans-translator-cwd-workingdirectory">
<h2><span class="section-number">3.22. </span>Using an external transpiler: __pragma__ (‘xtrans’, &lt;translator&gt;, …, cwd = &lt;workingdirectory&gt;)<a class="headerlink" href="#using-an-external-transpiler-pragma-xtrans-translator-cwd-workingdirectory" title="Permalink to this headline">#</a></h2>
...
<section id="create-bare-javascript-objects-and-iterate-over-their-attributes-from-python-pragma-jsiter-and-pragma-nojsiter">
<h2><span class="section-number">3.23. </span>Create bare JavaScript objects and iterate over their attributes from Python: __pragma__ (‘jsiter’) and __pragma__ (‘nojsiter’)<a class="headerlink" href="#create-bare-javascript-objects-and-iterate-over-their-attributes-from-python-pragma-jsiter-and-pragma-nojsiter" title="Permalink to this headline">#</a></h2>
